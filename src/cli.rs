...
pub struct DeviceOptions {
    ...
    #[arg(long)]
    #[arg(long, conflicts_with = "credentials_secret")]
...
impl DeviceOptions {
    pub fn merge(self, config: &mut Config) {
        ...
        config.interfaces_directory.merge(self.interfaces_directory);
        config.store_directory.merge(self.store_directory);
    }
}
